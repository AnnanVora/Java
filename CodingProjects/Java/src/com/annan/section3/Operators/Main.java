package com.annan.section3.Operators;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("2 times 10 = " + result);
        ...
        // result = result * 10
        result *= 10; // 3 * 10 = 30
        System.out.println("3 times 10 = " + result);
        ...
        double myThirdValue = ((myFirstValue + mySecondValue) * 100) % 40.00d;
        boolean isNoRemainder = (myThirdValue == 0) ? true : false;
