package com.annan.exercises.CodingExercise27;//Write a method called inputThenPrintSumAndAverage that does not have any parameters.
//
...
public class InputCalculator {
    ...
    public static void inputThenPrintSumAndAverage() {
        ...
        while (true) {
            ...
            } else System.out.println("SUM = " + (int) sum + " AVG = " +  (int) Math.ceil(average));
                break;
        }
    }
}
