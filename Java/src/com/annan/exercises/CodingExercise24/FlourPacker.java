package com.annan.exercises.CodingExercise24;//Write a method named canPack with three parameters of type int named bigCount, smallCount, and goal.
//
...
public class FlourPacker {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(canPack(4, 11, 31));
